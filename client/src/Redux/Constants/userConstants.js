...
export const DELETE_FAVORITE_PRODUCTS_REQUEST = "DELETE_FAVORITE_PRODUCTS_REQUEST";
export const DELETE_FAVORITE_PRODUCTS_SUCCESS = "DELETE_FAVORITE_PRODUCTS_SUCCESS";
export const DELETE_FAVORITE_PRODUCTS_FAIL = "DELETE_FAVORITE_PRODUCTS_FAIL";
export const DELETE_FAVORITE_PRODUCTS_RESET = "DELETE_FAVORITE_PRODUCTS_RESET";

export const DELETE_FAVORITE_PRODUCT_REQUEST = "DELETE_FAVORITE_PRODUCT_REQUEST";
export const DELETE_FAVORITE_PRODUCT_SUCCESS = "DELETE_FAVORITE_PRODUCT_SUCCESS";
export const DELETE_FAVORITE_PRODUCT_FAIL = "DELETE_FAVORITE_PRODUCT_FAIL";
export const DELETE_FAVORITE_PRODUCT_RESET = "DELETE_FAVORITE_PRODUCT_RESET";
